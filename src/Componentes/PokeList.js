...
function getSteps() {
    return ['The basics.',import React, { Component } from 'react'
import {
    Dialog,
    TextField,
    Button,
...
class PokeList extends Component {
    ...
    listPokeList(PokeList) {
        return (
            <GridListTile key={PokeList.url} style={{ height: 400, width: 400 }}>
                <img src={PokeList.url} style={{heig: 300, width:300}}></img>
                <GridListTileBar
                    title={PokeList.name}
    ...
    getStepContent = (step) => {
        switch (step) {
            case 0:
                return (
                    <Paper style={{display: 'flex',flexDirection: 'column', alignItems: 'center', alignContent: 'center', height: 400, color: "black" }}>
                        <br />
...
export default withRouter(PokeList); 'A little important information.', 'Final step'];
}
